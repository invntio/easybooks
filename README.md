...
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=invntio_invntio&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=invntio_invntio)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=invntio_invntio&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=invntio_invntio)
[![codecov](https://codecov.io/gh/invntio/easybooks/graph/badge.svg?token=V6WDKGCSP7)](https://codecov.io/gh/invntio/easybooks)
